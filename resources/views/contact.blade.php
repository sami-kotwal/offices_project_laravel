                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-6">
                                    <input type="text" name="number" class="form-control" id="number"
                                        placeholder="Your Number" value="{{ old('number') }}" />
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <select class="select form-control" name="project">
                                            ...
                                            <option value="ERP Design">ERP Consultant Services</option>
                                            <option value="Mobile App Development">Mobile App Development</option>
                                            <option value="Desktop Application Development">Desktop Application Development
                                            </option>

                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card wow bounceInUp">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    In a mobile-centric landscape, we offer app development, delivering seamless
                                    experiences, driving engagement, and ensuring high-quality performance.
                                </p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card wow bounceInUp">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Expertly and meticulously crafted by our adept team, we design robust, user-friendly
                                    desktop apps to streamline tasks, enhance productivity, and ensure secure business
                                    operations.
                                </p>
        ...
        <section id="team">
            <div class="container">
                <div class="section-header">
                    <h3>Our Owners </h3>
                    <p>Introducing our exceptional leaders: Dawood Fareed, Syed Zain Ul Abadin, and Abdul Moueed. Their
                        visionary guidance drives our success. </p>
                </div>

                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="member">
                            <img src="assets/images/dawod.jpeg" class="img-fluid" alt="" />
                        ...
                        <div class="member">
                            ...
                            <div class="member-info">
                                <div class="member-info-content">
                                    ...
                                    <span>CO-FOUNDER & CEO </span>
                                    <div class="social">
                                        <a href="https://twitter.com/JDCZain" target="_blank" ><i class="fa-brands fa-twitter"></i></a>
                                        <a href="https://www.facebook.com/JDCZain?mibextid=ZbWKwL" target="_blank"><i class="fa-brands fa-facebook"></i></a>
                                        <a href="https://www.linkedin.com/in/syed-zain-ul-abadin/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mx-auto wow fadeInUp">
                        <div class="member">
                            ...
                            <div class="member-info">
                                <div class="member-info-content">
                                    ...
                                    <span>CO-FOUNDER</span>
                                    <div class="social">
                                        <a href="https://x.com/Abdul_Moueed_?t=-aaogcdneHEKnxguoZX76A&s=08" target="_blank"><i class="fa-brands fa-twitter"></i></a>
                                        <a href="https://www.facebook.com/profile.php?id=100008754220079&mibextid=b06tZ0" target="_blank"><i class="fa-brands fa-facebook"></i></a>
                                        <a href="https://www.linkedin.com/in/abdul-moueed-41ab8318b/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row no-gutters clients-wrap clearfix wow fadeInUp mt-5">
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="assets/images/intel.png" style="height: 100px" class="img-fluid" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="assets/images/walls.png" style="height: 100px" class="img-fluid" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="assets/images/dell.png" style="height: 100px" class="img-fluid" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="assets/images/shell.png " style="height: 100px" class="img-fluid"
                                alt="" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="assets/images/ptcl.jpg" style="height: 100px" class="img-fluid" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="assets/images/tapal.png" style="height: 100px" class="img-fluid" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="assets/images/itel.png" style="height: 100px" class="img-fluid" alt="" />
                        </div>
                    </div>
